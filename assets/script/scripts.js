...
function downloadCodeAsImage(id) {
  const codeElement = document.getElementById(id).parentElement; 
  ...
  footer.innerText = "- Developer: Kawsar Ahmed (github.com/kawsarcodes)";
  ...
  footer.style.borderRadius = "2px 2px 0 0"
  ...
  const formattedDateTime = `[Image Generated on: 🗓️ ${day} ${month}, ${year} | ⏰ ${timeStr}]`;
  const dateFooter = document.createElement("div");
  dateFooter.innerText = formattedDateTime;
  dateFooter.style.color = "lightgray";
  dateFooter.style.fontSize = "8px";
  dateFooter.style.fontFamily = "monospace";
  dateFooter.style.textAlign = "center";
  dateFooter.style.backgroundColor = "#141414"
  dateFooter.style.color = "#fff"
  dateFooter.style.borderRadius = "0 0 2px 2px"
  dateFooter.style.padding = "0 3px 6px 3px"
  wrapper.appendChild(dateFooter);
  document.body.appendChild(wrapper);
  html2canvas(wrapper, { backgroundColor: "#1e1e1e", scale: 2 }).then(canvas => {
    const link = document.createElement("a");
    link.download = id + "_(uiuNerds).png";
